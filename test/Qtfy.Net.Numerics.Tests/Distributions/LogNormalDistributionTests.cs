...
namespace Qtfy.Net.Numerics.Tests.Distributions
{
    ...
    public class LogNormalDistributionTests
    {
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).Mean);
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).Variance);
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).StandardDeviation);
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).Quantile(probability));
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).Density(x));
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).DensityLn(x));
        }
        ...
        {
            AssertClose(expected, new LogNormalDistribution(mu, sigma).CumulativeDistribution(x));
        }
    }
}
