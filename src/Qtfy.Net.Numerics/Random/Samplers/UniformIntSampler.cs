...
namespace Qtfy.Net.Numerics.Random.Samplers
{
    ...
    /// </summary>
    public sealed class UniformIntSampler : UniformDiscreteSampler<int>
    {
        ...
        /// </param>
        public UniformIntSampler(IRandomNumberEngine generator, int min, int max)
            : base(min, max)
        {
        ...
        {
            return this.generator.NextInt(this.Min, this.Max);
        }
    }
}
